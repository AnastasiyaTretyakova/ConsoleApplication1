...
string gamemenu[] = {    //внутриигровое меню
	 "Выберите тему: \n",
	"1. Школьные вопросы - легкий уровень сложности \n",
	"2. Наука и технологии - средний уровень сложности \n",
	"3. Видеоигры - средний уровень сложномти \n",
	"4. Спорт - тяжёлый уровень сложнсти\n",
...
void pravila() { 
	...
	cout << "Правила: \n";
	cout << "=======================================" << endl;
	cout << "-----Игра “Кто хочет стать миллионером?” - это конкурс викторина, в которой нужно правильно ответить на ряд вопросов с несколькими вариантами ответов. Всего 10 вопросов, каждый вопрос стоит определённой суммы денег, в зависимости от выбранной темы. \n";
	cout << "" << endl;
	cout << "-----Вопросы “Кто хочет стать миллионером?” структурированы в соответствии с четырьмя различными категориями, такими как “Школьные вопросы”, “Наука и технологии”, “Видеоигры”, “Спорт”. Каждая категория подразумевает свой уровень сложности. \n";
	cout << "" << endl;
	cout << "-----При ответах на вопросы запрещено пользоваться подсказками, интернетом и тому подобными вещами.\n";
	cout << "" << endl;
	cout << "-----Удачной игры!\n";
	cin.get();
	cin.get();
...
void game() {
	...
	int nzv[10] = { 100,100,100,100,100,100,100,100,100,100 };  //массив, чтобы вопросы не повторялись
	int x;
	int nachislenia; //добавление денег за определённую тему вопроса
